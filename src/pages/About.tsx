...
const fadeInUpTransition: Transition = { duration: 0.7, ease: "easeOut" };
...
export function About() {
  ...
  return (
    <>
      <Helmet>
        <title>Sobre a Genevieve | Especialistas em Presença Digital </title>
        <meta
          name="description"
          content="Conheça a Genevieve. Unimos engenharia de software e design estratégico para criar soluções digitais que geram autoridade para profissionais liberais e empresas."
        />
      </Helmet>
              ...
              >
                ...
                <div className="space-y-6 text-lg text-zinc-600 leading-relaxed">
                  ...
                  <p>
                    ...
                    ajudam empresas de obras a serem encontradas, gerar contatos
                    e fechar mais contratos.
                  </p>
