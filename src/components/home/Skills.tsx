...
export function Skills() {
  return (
    <section className="py-24 bg-[#F2F2F2] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:grid md:grid-cols-2 gap-12 md:items-center">
        <h3 className="font-beauty text-black text-6xl font-black tracking-tighter mb-16 order-1 md:order-1 md:col-span-2 lg:col-span-1">
          HABILIDADES
        </h3>

        <div className="relative order-2 md:order-3 lg:order-2">
          <h2 className="text-[120px] font-black text-black/5 absolute -top-20 -left-10 select-none">
            ESSENCIAL
          </h2>
